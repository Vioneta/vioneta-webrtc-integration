...
![](https://img.shields.io/github/stars/Vioneta/vioneta-webrtc-integration?style=flat-square&logo=github) 
![](https://img.shields.io/github/forks/Vioneta/vioneta-webrtc-integration?style=flat-square&logo=github) 

[Vioneta](https://www.vioneta.com/) custom component for real-time viewing of almost any camera stream using [WebRTC](https://en.wikipedia.org/wiki/WebRTC) and other technologies.
...
**PS.** There is also another nice card with go2rtc support - [Vioneta VCam Card](https://github.com/Vioneta/vioneta-vcam-card).

## Installation

**Method 1.** [VPS](https://vps.vioneta.com/) > Integrations > Plus > **WebRTC** > Install

**Method 2.** Manually copy `webrtc` folder from [latest release](https://github.com/Vioneta/vioneta-webrtc-integration/releases/latest) to `/config/custom_components` folder.

<details>
  <summary>Additional steps if you are using the UI in YAML mode: add card to resources</summary>

  The `custom_card` will be automatically registered with the Vioneta UI, except when you are managing the UI in YAML mode.
...
poster: https://www.vioneta.com/images/logo.png  # still image when stream is loading
...
Pan, tilt, zoom controls: [PTZ config examples](https://github.com/Vioneta/vioneta-webrtc-integration/wiki/PTZ-Config-Examples).
...
**Video aspect ratio** [issue](https://github.com/Vioneta/vioneta-webrtc-integration/issues/21)
...
[New in v3.6.0](https://github.com/Vioneta/vioneta-webrtc-integration/releases/tag/v3.6.0).
...
[New in v3.4.0](https://github.com/Vioneta/vioneta-webrtc-integration/releases/tag/v3.4.0).
...
**PS.** For Vioneta [Mobile App](https://www.vioneta.com/integrations/mobile_app/) ensure that you can use microphone with the built-in [Assist](https://www.vioneta.com/voice_control/).
...
Component support streaming to [Google Cast](https://www.vioneta.com/integrations/cast/) Chromecast devices (including Android TV and Google Smart Screen). Read more in [wiki](https://github.com/Vioneta/vioneta-webrtc-integration/wiki/Cast-or-share-camera-stream).

Also component support creating a temporary or permanent link to a stream without sharing access to you Vioneta. Read more in [wiki](https://github.com/Vioneta/vioneta-webrtc-integration/wiki/Cast-or-share-camera-stream).

## Stream to camera

[New in v3.1.0](https://github.com/Vioneta/vioneta-webrtc-integration/releases/tag/v3.1.0).

go2rtc support play audio files (ex. [music](https://www.vioneta.com/integrations/media_source/) or [TTS](https://www.vioneta.com/integrations/#text-to-speech)) and live streams (ex. radio) on cameras with [two way audio](https://github.com/AlexxIT/go2rtc#two-way-audio) support. You need to:
...
4. Create virtual [Media Players](https://www.vioneta.com/integrations/media_player/) for your cameras in `configuration.yaml`:
...
| Raspberry Pi | PiCam                                                 | [read more](https://github.com/Vioneta/vioneta-webrtc-integration/issues/261)                                                                                                                                                                            |
